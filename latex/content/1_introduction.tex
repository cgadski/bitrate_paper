...
\item On the other hand, we show that $C(\eta)$ is surprisingly large for values of $(N, k)$ typical in sparse autoencoder research. In particular, we show empirically that there is a large gap between the capacity of 
\end{enumerate}
