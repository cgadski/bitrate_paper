...
\item \Cref{sec:information} briefly realls the idea of a Shannon limit and explains two different heuristic predictions for the number of dimensions that may be required for a superposition code to be decodable.
