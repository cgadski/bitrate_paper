...
The difficulty of decoding a superposition code
for example to reduce the scale of ``crosstalk'' between distinct codewords.

\begin{proposition}[KL bound]
asdf
\end{proposition}
...
$$
For each $i \in [N],$ this is a sum of between $k$ and $(k - 1)$ numbers drawn without replacement from the sequence $(\langle f_i, f_j \rangle)_{j \neq i}.$
...
\begin{minipage}[c]{0.5\textwidth}
	\begin{center}
	\includegraphics[width=\textwidth]{../figures/gd_interference}
