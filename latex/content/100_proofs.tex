...
$$
Since $F(\eta, \tau, C)$ is decreasing in $C,$ putting $\tau = (1 + \sqrt \eta)^{-1}$ guarantees that $F(\eta, \tau, C) < 0$ for any $C$ satisfying $\min_\tau F(\eta, \tau, C) < 0,$ although it is strictly larger than the true minimizer of $F.$
...
$$
\tau_{\text{MAP}} = \frac 1 2 - \rho^{-1} \ln \frac{\Pp(X_i = 1)}{\Pp(X_i = 0)} = \frac 1 2 - \frac k d \ln \frac k N + O\left( \frac k {dN} \right)
$$
when $k/N \to 0.$
