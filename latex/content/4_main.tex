...
\begin{figure}
	...
	\caption{Empirical performance of MAP thresholding and top-$k$ thresholding at decoding a $k$-element subset of $[N]$ from a $d$-dimensional superposition code using a random dictionary. The bold line shows the asymptotic requirement $d = (2 + 4 \sqrt{\eta} + 2 \eta)k \ln N$ predicted by \Cref{prop:sufficient-cond}, .}
	\label{fig:top-k}
	\end{center}
\end{figure}
